<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.master" AutoEventWireup="true" CodeFile="Report_category.aspx.cs" Inherits="Admin_Report_category" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div style="margin-top: 40PX; font-style: initial">
        <h2 style="margin-top: 20px;">
            <center><b>Category Details</b></center>
        </h2>
    </div>
    <div>
