<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.master" AutoEventWireup="true" CodeFile="Report_districts.aspx.cs" Inherits="Admin_Report_districts" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
        ...
        <h2 style="margin-top: 20px;">
            <center><b>District Details</b></center>
        </h2>
    </div>
    <div>
            ...
            <div style="margin-top: 50px;">
                <table class=" table table-bordered table-responsive">
                    <tr>
                        ...
                        <th style="color: green; text-align: center"><b>Districts</b></th>
                    ...
                    <asp:ListView ID="ListView1" runat="server">
                        <ItemTemplate>
                            <tr>
                                ...
                                <td style="text-align: center"><%#Eval("districtname")%></td>
