<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.master" AutoEventWireup="true" CodeFile="frm_district.aspx.cs" Inherits="Admin_frm_district" %>
     ...
     <div class="container">
        <div class="row">
            <div class="col-md-11" style="box-shadow: 2px 2px 10px #1b93e1; border-radius: 4px; top: 14px;">
                <h3 style="text-align: center"><b>DISTRICT REGISTRATION</b> </h3>
                <div class="form-horizontal">
                    <div class="form-group">
                        <label class="control-label col-sm-2" for="society">District Name</label>
                        <div class="col-sm-10">
                            <asp:TextBox ID="txtdistrictname" class="form-control" runat="server" Width="500px"></asp:TextBox>
