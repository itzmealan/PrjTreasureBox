<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.master" AutoEventWireup="true" CodeFile="Reports_locations.aspx.cs" Inherits="Admin_Reports_locations" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div style="margin-top: 40PX; font-style: initial">
        <h2 style="margin-top: 20px;">
            <center><b>Location Details</b></center>
        </h2>
    </div>
    <div>
            ...
            <div style="margin-top: 50px;">
                <table class=" table table-bordered table-responsive">
                    <tr>
                        ...
                        <th style="color: green; text-align: center"><b>Locations</b></th>
                    ...
                    <asp:ListView ID="ListView1" runat="server">
                        <ItemTemplate>
                            <tr>
                                ...
                                <td style="text-align: center"><%#Eval("locationname")%></td>
