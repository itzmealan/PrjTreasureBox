<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.master" AutoEventWireup="true" CodeFile="Report_customerContact.aspx.cs" Inherits="Admin_Report_customerContact" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
        ...
        <h2 style="margin-top: 20px;">
            <center><b>CUSTOMER CONTACT</b></center>
        </h2>
    </div>
    <div>
            ...
            <div style="margin-top: 50px;">
                <table class=" table table-bordered table-responsive">
                    <tr>
                        ...
                        <th style="color: green; text-align: center"><b>Customer</b></th>
