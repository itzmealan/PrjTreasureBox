<%@ Page Title="" Language="C#" MasterPageFile="~/Customer_new/CustomerMasterPage.master" AutoEventWireup="true" CodeFile="frm_Product_singleview.aspx.cs" Inherits="Customer_new_frm_Product_singleview" %>
...
<%--                            <asp:Button ID="Button1" runat="server" Text="ADD TO CART" CssClass="add-cart" BackColor="Black" ForeColor="White" Height="37px" OnClick="Button1_Click"  />--%>
			...
			--%>			
                          ...
                          <asp:LinkButton ID="LinkButton1" runat="server" Text="Add To Cart" CommandName="addtocart" CommandArgument="product_id" CssClass="add-cart" BackColor="Black" ForeColor="White" Height="37px"  OnClick="LinkButton1_Click"> </asp:LinkButton>                      
                          <asp:LinkButton ID="LinkButton2" runat="server" Text="Buy Now" CommandName="buynow" CommandArgument="product_id" CssClass="add-cart" BackColor="Black" ForeColor="White" Height="37px" OnClick="LinkButton2_Click"> </asp:LinkButton>                      
