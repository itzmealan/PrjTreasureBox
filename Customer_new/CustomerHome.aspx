<%@ Page Title="" Language="C#" MasterPageFile="~/Customer_new/CustomerMasterPage.master" AutoEventWireup="true" CodeFile="CustomerHome.aspx.cs" Inherits="Guest_GuestHome" %>
				...
				<div class="product-one">
					<div class="col-md-3 product-left">
						<div class="product-main simpleCart_shelfItem">
							...
							<div class="product-bottom">
								...
								<p>Explore Now</p>
								<h4><a class="item_add" href="#"><i></i></a> <span class=" item_price">4500</span></h4>
							</div>
							<div class="srch">
								<span>-50%</span>
							</div>
					...
					<div class="col-md-3 product-left">
						<div class="product-main simpleCart_shelfItem">
							...
							<div class="product-bottom">
								<h3>DELICATE TURQUOISE BAR NECKLACE</h3>
								<p>Explore Now</p>
								<h4><a class="item_add" href="#"><i></i></a> <span class=" item_price">6999</span></h4>
							</div>
							<div class="srch">
								<span>-50%</span>
							</div>
					...
					<div class="col-md-3 product-left">
						<div class="product-main simpleCart_shelfItem">
							...
							<div class="product-bottom">
								<h3>NASA MEATBALL EMBROIDERED 100% COTTON CAP</h3>
								<p>Explore Now</p>
								<h4><a class="item_add" href="#"><i></i></a> <span class=" item_price">590</span></h4>
							</div>
							<div class="srch">
								<span>-50%</span>
							</div>
					...
					<div class="col-md-3 product-left">
						<div class="product-main simpleCart_shelfItem">
							...
							<div class="product-bottom">
								<h3>BASEBALL HAT</h3>
								<p>Explore Now</p>
								<h4><a class="item_add" href="#"><i></i></a> <span class=" item_price">690</span></h4>
							</div>
							<div class="srch">
								<span>-50%</span>
							</div>
				...
				<div class="product-one">
					<div class="col-md-3 product-left">
						<div class="product-main simpleCart_shelfItem">
							...
							<div class="product-bottom">
								<h3>PURPLE CHEONGSAM COCKTAIL DRESS</h3>
								<p>Explore Now</p>
								<h4><a class="item_add" href="#"><i></i></a> <span class=" item_price">4500</span></h4>
							</div>
							<div class="srch">
					...
					<div class="col-md-3 product-left">
						<div class="product-main simpleCart_shelfItem">
							...
							<div class="product-bottom">
								<h3>BE KIND. TEE T-SHIRT</h3>
								<p>Explore Now</p>
								<h4><a class="item_add" href="#"><i></i></a> <span class=" item_price">1550</span></h4>
							</div>
							<div class="srch">
								<span>-50%</span>
							</div>
					...
					<div class="col-md-3 product-left">
						<div class="product-main simpleCart_shelfItem">
							...
							<div class="product-bottom">
								...
								<p>Explore Now</p>
								<h4><a class="item_add" href="#"><i></i></a> <span class=" item_price">2500</span></h4>
							</div>
							<div class="srch">
								<span>-50%</span>
							</div>
		...
		<div class="container">
			<div class="infor-top">
				...
				<div class="col-md-3 infor-left">
					...
					<h5>+91 99 12 34 56 78</h5>	
					<p><a href="#">contact@treasurebox.com</a></p>
				</div>
				<div class="clearfix"></div>
			</div>
		</div>
